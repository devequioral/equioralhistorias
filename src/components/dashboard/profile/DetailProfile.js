...
import styles from '@/styles/dashboard/profile/DetailProfile.module.css';
...
export default function DetailProfile(props) {
  ...
  const [isSaving, setIsSaving] = React.useState(savingRecord);
  ...
  return (
    <>
      <div className={`${styles.DetailProfile}`}>
        <h3 className={`${styles.MainTitle}`}>Detalles de su Perfil</h3>
        {isLoading ? (
